...
+
image::adv-module04/04-image-affinity-v2.png[title="Edit Node Labels", link=self, window=blank, width=100%]

+
In the new window, enter *zone=east* and click *Save*

+
image::adv-module04/04-image-affinity-labels.png[title="Add Label", link=self, window=blank, width=100%]
...
+
image::adv-module04/04-image-affinity-check-labels.png[title="Check the Label", link=self, window=blank, width=100%]
...
+
image::adv-module04/04-image-affinity01.png[title="Node Affinity Navigation", link=self, window=blank, width=100%]

+
. From the *Configuration* tab, select *Scheduling* and click the *blue pencil* icon under *Affinity rules* to add a new one.

+
image::adv-module04/04-image-affinity02.png[title="Node Affinity add rule", link=self, window=blank, width=100%]

+
. Click *Add affinity rule*.

+
image::adv-module04/04-image-affinity02a.png[title="Node Affinity add rule", link=self, window=blank, width=100%]
...
+
image::adv-module04/04-image-affinity03.png[title="Node Affinity Rule", link=self, window=blank, width=100%]

+
. Click *Apply rules*.

+
image::adv-module04/04-image-affinity03a.png[title="Node Affinity Rule", link=self, window=blank, width=100%]
...
+
image::adv-module04/04-image-affinity04.png[title="Pod Affinity Rule", link=self, window=blank, width=100%]
...
+
image::adv-module04/04-image-affinity05.png[title="Pod Affinity Rule", link=self, window=blank, width=100%]
...
+
image::adv-module04/04-image-affinity06.png[title="Add Pod Anti-Affinity Rule", link=self, window=blank, width=100%]
...
+
image::adv-module04/04-image-affinity07.png[title="Add Pod Anti-Affinity Rule", link=self, window=blank, width=100%]
