...
+
image::adv-module07/image1-ui-src-vm-running.png[title="Source Virtual Machine Details - Running", link=self, window=blank, width=100%]
...
+
image::adv-module07/image2-ui-dest-waiting.png[title="Destination Virtual Machine Details - WaitingForReceiver", link=self, window=blank, width=100%]

+
If the *Migration* has started and is in the early stages, the VM will a status of *Starting*.

+
image::adv-module07/image3-ui-dest-starting.png[title="Destination Virtual Machine Details - Starting", link=self, window=blank, width=100%]

+
When the *Source* and *Destination* are ready, the status of the *Destination* VM will change to *Migrating*.

+
image::adv-module07/image4-ui-dest-migrating.png[title="Destination Virtual Machine Details - Migrating", link=self, window=blank, width=100%]
...
+
image::adv-module07/image5-ui-migrating-overview-panel.png[title="Destination Virtual Machine - Migration Pop-up Panel", link=self, window=blank, width=100%]
...
+
image::adv-module07/image6-ui-dest-migrating-metrics.png[title="Destination Virtual Machine - Migration Metrics", link=self, window=blank, width=100%]

+
Scrolling down on the *Metrics* page, you will see more migration metrics and a *LiveMigration progress* bar.

+
image::adv-module07/image7-ui-dest-migrating-metrics2.png[title="Destination Virtual Machine - Migration Metrics", link=self, window=blank, width=100%]
...
+
image::adv-module07/image8-ui-dest-migrating-progress-bar.png[title="Destination Virtual Machine - Migration Progress Bar", link=self, window=blank, width=100%]
...
+
image::adv-module07/image9-ui-dest-running-src-stopped.png[title="Destination Virtual Machine - Running & Source Virtual Machine - Stopped, link=self, window=blank, width=100%]
...
+
image::adv-module07/ui/image1-click-migration-plans.png[title="Migration Plans", link=self, window=blank, width=100%]
...
+
image::adv-module07/ui/image2-click-create-plans.png[title="Create Migration Plan", link=self, window=blank, width=100%]
...
+
image::adv-module07/ui/image3-planinfo-name-project.png[title="Create migration plan", link=self, window=blank, width=100%]
...
+
image::adv-module07/ui/image4-planinfo-source-target-providers.png[title="Create migration plan", link=self, window=blank, width=100%]
...
+
image::adv-module07/ui/image5-select-virtual-machine.png[title="Select Virtual Machine", link=self, window=blank, width=100%]
...
image::adv-module07/ui/image6-new-network-map.png[title="Create Network Map", link=self, window=blank, width=100%]
...
+
image::adv-module07/ui/image7-new-storage-map.png[title="Create Storage Map", link=self, window=blank, width=100%]
...
+
image::adv-module07/ui/image8-migration-type-live.png[title="Migration Type", link=self, window=blank, width=100%]
...
+
image::adv-module07/ui/image9-power-state.png[title="Other Settings", link=self, window=blank, width=100%]
...
+
image::adv-module07/ui/image10-migration-hooks.png[title="Hooks", link=self, window=blank, width=100%]
...
+
image::adv-module07/ui/image11-review-create.png[title="Review and Create", link=self, window=blank, width=100%]
...
+
image::adv-module07/ui/image12-plan-created-error.png[title="Plan Details", link=self, window=blank, width=100%]
