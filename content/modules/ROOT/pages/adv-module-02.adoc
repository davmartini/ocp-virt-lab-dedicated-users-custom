...
+
image::adv-module02/node-details.png[title="Confirm number of CPUs", link=self, window=blank, width=100%]
...
+
image::adv-module02/start-vm.png[title="Start VM", link=self, window=blank, width=100%]
...
+
image::adv-module02/vm-details.png[title="Confirm number of CPUs", link=self, window=blank, width=100%]
...
+
image::adv-module02/overcommit-nproc.png[title="Confirm number of CPUs", link=self, window=blank, width=100%]
...
+
image::adv-module02/pod-cpu-details.png[title="Confirm number of CPUs", link=self, window=blank, width=100%]
...
+
image::adv-module02/vm-memory-assigned.png[title="VM Memory Assigned", link=self, window=blank, width=100%]
...
+
image::adv-module02/virt-launcher-memory-request.png[title="Virt-Launcher Memory Request", link=self, window=blank, width=100%]
...
+
image::adv-module02/enable-memory-overcommit.png[title="Enable Memory Overcommit", link=self, window=blank, width=100%]
...
+
image::adv-module02/virt-launcher-memory-request-overcommit.png[title="Virt-Launcher Memory Request 1.5x", link=self, window=blank, width=100%]
