...
+
image::adv-module06/06-image-nodehealthcheck-v2.png[title="Create NodeHealthCheck", link=self, window=blank, width=100%]
...
+
image::adv-module06/06-image-nodehealthcheck2.png[title="Create NodeHealthCheck", link=self, window=blank, width=100%]
...
+
image::adv-module06/06-image-nodehealthcheck3.png[title="Create NodeHealthCheck", link=self, window=blank, width=100%]
...
+
image::adv-module06/06-image-nodehealthcheck4.png[title="Node remediation running", link=self, window=blank, width=100%]
