...
+
image::adv-module03/03-image-cpu-001.png[title="CPU and Memory before hot plug", link=self, window=blank, width=100%]
...
+
image::adv-module03/03-image-cpu-002.png[title="Virtual Machine details", link=self, window=blank, width=100%]
...
+
image::adv-module03/03-image-cpu-003.png[title="Edit Instance Type", link=self, window=blank, width=100%]

. The configuration in the Details panel will now show that the virtual machine has 2 CPUs and 4 GiB of memory.

+
image::adv-module03/03-image-cpu-004.png[title="Virtual Machine details", link=self, window=blank, width=100%]
...
+
image::adv-module03/03-image-cpu-005.png[title="CPU and Memory messages", link=self, window=blank, width=100%]
...
+
image::adv-module03/03-image-cpu-006.png[title="Login to VM", link=self, window=blank, width=100%]
...
+
image::adv-module03/03-image-cpu-007.png[title="Verify new resources", link=self, window=blank, width=100%]
...
+
image::adv-module03/03-image-disk-001.png[title="hot-plug-vm1 details", link=self, window=blank, width=100%]
...
+
image::adv-module03/03-image-disk-002.png[title="VM has only one disk", link=self, window=blank, width=100%]

. Add an empty disk by clicking the *Add* button under *Disks* and then selecting *Empty disk (blank)*.

+
image::adv-module03/03-image-disk-003.png[title="Add an empty disk", link=self, window=blank, width=100%]
...
+
image::adv-module03/03-image-disk-004.png[title="Configure the new disk", link=self, window=blank, width=100%]

+
. The new disk has been added with a label of *Persistent Hotplug*.

+
image::adv-module03/03-image-disk-005.png[title="The disk is added", link=self, window=blank, width=100%]
...
+
image::adv-module03/03-image-disk-006.png[title="Kernel messages about a new disk", link=self, window=blank, width=100%]
...
+
image::adv-module03/03-image-disk-007.png[title="View the new disk from the OS", link=self, window=blank, width=100%]
...
+
image::adv-module03/03-image-disk-011.png[title="Detach the disk", link=self, window=blank, width=100%]

. Confirm the action by clicking on the *Detach* button.

+
image::adv-module03/03-image-disk-012.png[title="Confirm disk detach", link=self, window=blank, width=100%]
...
+
image::adv-module03/03-image-disk-013.png[title="Disk is removed in OS", link=self, window=blank, width=100%]
...
+
image::adv-module03/03-image-disk-persist-002.png[title="Stop the VM", link=self, window=blank, width=100%]
...
+
image::adv-module03/03-image-disk-persist-003.png[title="Add a volume", link=self, window=blank, width=100%]
...
+
image::adv-module03/03-image-disk-persist-004.png[title="Select the PVC", link=self, window=blank, width=100%]
...
+
image::adv-module03/03-image-disk-persist-005.png[title="Both disks are attached", link=self, window=blank, width=100%]

+
. Start the virtual machine by clicking on the *blue Play icon*, or by selecting the *Actions* menu and clicking *Start*.

+
image::adv-module03/03-image-disk-persist-006.png[title="Both disks are attached", link=self, window=blank, width=100%]
...
+
image::adv-module03/03-image-disk-persist-007.png[title="The disk is attached", link=self, window=blank, width=100%]
...
+
image::adv-module03/03-image-nic-002.png[title="Identify the worker node", link=self, window=blank, width=100%]
...
+
image::adv-module03/03-image-nic-003a.png[title="Single NIC only", link=self, window=blank, width=100%]

+
You may also login to the VM via the *Console* tab and view the *NIC* details from the operating system.

+
image::adv-module03/03-image-nic-003b.png[title="Single NIC in Console", link=self, window=blank, width=100%]
...
+
image::adv-module03/03-image-nic-004.png[title="Add network interface", link=self, window=blank, width=100%]
...
+
image::adv-module03/03-image-nic-005.png[title="View pending changes", link=self, window=blank, width=100%]
...
+
image::adv-module03/03-image-nic-008.png[title="Messages on console about new NIC", link=self, window=blank, width=100%]
...
+
image::adv-module03/03-image-nic-009.png[title="New NIC is up", link=self, window=blank, width=100%]
